...
void atenderSenha(int id, Guiche *guiche, Fila *senhas, Fila *senhasAtendidas)
{
    float senha = dequeue(senhas);
...
int main()
{
    ...
    while (opcao != 0)
    {
        ...
        else if (opcao == 3)
        {
            ...
            {
                atenderSenha(id, guiches, senhas, senhasAtendidas);
            }
            else
            {
    ...
    cout << "Quantidade de atendimentos: " << count(senhasAtendidas) << endl;
    freeFila(senhas);
